...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
  ...
  if (cell.accessoryType == UITableViewCellAccessoryCheckmark) {
    ...
    self.item.itemAromas = [self.item.itemAromas stringByReplacingOccurrencesOfString:[aroma valueForKey:@"taste"] withString:@""];
    self.item.itemAromas = [self.item.itemAromas stringByReplacingOccurrencesOfString:@", , " withString:@", "];
  } else {
    cell.accessoryType = UITableViewCellAccessoryCheckmark;
    
    self.item.itemAromas = [NSString stringWithFormat:@"%@, %@", self.item.itemAromas, [aroma valueForKey:@"taste"]];
  }
